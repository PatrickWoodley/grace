  ...
  return (
    <div style={{ fontFamily: "sans-serif" }}>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: "#666" }}>
              Your answers are turned into a structured file your AI can
              actually use — written in a way that feels personal, clear, and
              useful.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ color: "#666" }}>
              Copy and paste your SOUL.md into ChatGPT, Claude, or your
              preferred LLM to get more aligned, honest, and grounded
              responses.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <p style={{ color: "#666", marginBottom: "3rem" }}>
          It’s not just information — it’s a structured reflection of who you
          are.
        </p>
        ...
        >
          <div>
            <h3>Core Identity</h3>
            <p style={{ color: "#666" }}>
              Who you are and who you&apos;re becoming — not just labels, but
          ...
          <div>
            <h3>Patterns</h3>
            <p style={{ color: "#666" }}>
              Your recurring behaviors — how you respond under pressure, what
              you avoid, and the loops you repeat.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ color: "#666" }}>
              The things you already know but haven’t acted on — the
              uncomfortable clarity most advice ignores.
            </p>
          </div>
          ...
          <div>
            <h3>AI Guidance</h3>
            <p style={{ color: "#666" }}>
              How your AI should support you — when to challenge you, push you,
              or call you out.
            </p>
          </div>
        </div>
        ...
        <p style={{ marginTop: "3rem", fontWeight: "bold" }}>
          This gives your AI something it normally never has: a real model of
          you.
        </p>
      </div>
